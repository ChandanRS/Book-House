...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div id=\"alert-popup\" class=\"alert  alert--".concat(type, "\">").concat(msg, "</div>");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log("res.data: ".concat(res.data));
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            console.log(res); //alert(email,password)
          ...
          case 5:
            ...
            if (res.data.status === 'Success' || 'success') {
              (0, _alerts.showAlert)('success', 'Welcome to the Book House!');
              window.setTimeout(function () {
                location.assign('/');
              }, 5000);
            }
...
var stripe = Stripe('pk_test_51H0pIrHcOSZZbxrm1JtxvShHkCv6KIBQ1s2MqKBCLFiYHX97oIkyErVfaUmHH4N2x55mdGYgXrNkpUlT5bI07KnQ001wU4PPAQ');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(bookId));
...
if (loginForm) document.querySelector('.form--login').addEventListener('submit', function (e) {
  ...
  (0, _login.login)(email, password); // document.getElementById('email').value='';
